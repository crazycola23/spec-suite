...
- Codex loads this root `AGENTS.md` and may layer narrower instruction files toward the working directory.
- Before editing common discipline, modify `contracts/agent-entry.yaml` and rerender this region.
- Put Codex-only file discovery, tool behavior, or context constraints here; do not copy common rules here.
